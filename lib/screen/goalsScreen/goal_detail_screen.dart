...
class GoalInsideScreen extends StatefulWidget {
  const GoalInsideScreen({Key? key}) : super(key: key);

  @override
  State<GoalInsideScreen> createState() => _GoalInsideScreenState();
}

class _GoalInsideScreenState extends State<GoalInsideScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(appBar: AppBar(title: Text("New Goal"),),body:
      ...
      ListView(children: [
        ...
        ElevatedButton(onPressed: (){
          ...
          final goal = <String, dynamic>{
            ...
            "saved": double.parse(saveController.text.toString()),
