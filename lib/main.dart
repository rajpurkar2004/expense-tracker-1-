...
import 'package:expensetrackerapp/screen/auth_screen/signIn_screen.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  @override
  Widget build(BuildContext context) {
    return StreamBuilder(stream: FirebaseAuth.instance.authStateChanges(),builder: (ctx,userSanpshot){
